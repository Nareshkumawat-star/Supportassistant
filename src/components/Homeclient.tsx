            ...
            <div className='fixed top-0 left-0 right-0 z-50'>
                ...
                >
                    <div className='max-w-screen-2xl mx-auto flex w-full px-5 items-center justify-between' >
                        <div>
                            <h1 className='text-lg font-bold tracking-tight text-white'>SmartAssist <span className='text-zinc-400'>AI</span></h1>
                        </div>
                        {email ? (
                            <div className='text-sm text-white relative'>
                                <button
                                    ref={buttonRef}
                                    className='w-9 h-9 flex items-center justify-center bg-white text-zinc-900 rounded-full text-sm font-bold hover:bg-zinc-200 transition-colors shadow-sm'
                                ...
                                {open && (
                                    <motion.div
                                        ...
                                        className='absolute top-12 right-0 w-72 bg-white rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] p-5 border border-zinc-100 z-[100]'
                                    >
                                        <div className="flex items-center gap-3 mb-4">
                                            <div className="w-10 h-10 bg-zinc-900 rounded-full flex items-center justify-center text-white font-bold text-lg">
                                                {firstletter}
                                            </div>
                                            <div className="flex-1 min-w-0">
                                                <p className='text-sm text-zinc-900 font-bold truncate'>{email}</p>
                                                <p className='text-[10px] text-zinc-400 font-bold uppercase tracking-wider'>Pro Account</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-1 mb-4">
                                            <button
                                                ...
                                                className='w-full flex items-center gap-3 px-3 py-2 text-sm text-zinc-600 hover:text-zinc-900 hover:bg-zinc-50 rounded-xl transition-all font-semibold'
                                            >
                                        ...
                                        <button
                                            ...
                                            className='w-full flex items-center gap-3 px-3 py-2 text-sm text-red-500 hover:text-red-600 hover:bg-red-50/50 rounded-xl transition-all font-semibold'
                                        >
                ...
                >
                    ...
                    <div className="mt-10 flex flex-wrap gap-4">
                        ...
                        <button
                            ...
                            className="px-8 py-3 bg-white border border-zinc-200 text-zinc-700 rounded-full font-bold hover:bg-zinc-50 transition-all "
                        >
                            Learn More
                        </button>
                    </div>
